...
class LoginBottomSheetViewController: UIViewController {
    ...
    private func setupConstraints() {
        ...
        let heightConstraint = contentView.heightAnchor.constraint(equalTo: self.view.heightAnchor, multiplier: 0.54).isActive = true
    }
    ...
    @objc
    private func keyboardWilHide(notification: Notification) {
        UIView.animate(withDuration: 0.3) {
    ...
    private func askEnableFaceId(email: String) {
        ...
        if supportsBiometry {
            let alert = UIAlertController(title: "Habilitar o FaceID?", message: "Deseja habilitar o login por biometria?", preferredStyle: .alert)
